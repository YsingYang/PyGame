...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self, startpos=(50, 50), area=screen.get_rect()):
        pygame.sprite.Sprite.__init__(self, self.groups)#这里用Super都不能行
        self.pos = [0.0, 0.0]
...
try:
    Bird.image.append(pygame.image.load(os.path.join("resource", "babytux.png")))
    Bird.image.append(pygame.image.load(os.path.join("resource", "babytux_neg.png")))
except:
